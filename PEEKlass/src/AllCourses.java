...
public class AllCourses {
	...
	public void addCourses(){
		...
		Course course311 = new Course(com311, "Algorithms", com187, time16, time17, MW() );
		allCourses.put(com311,  course311);
		
		CourseNum com326 = new CourseNum(cs, 326);
		Course course326 = new Course(com326, "Web Programming", com187, time16, time17, TTH() );
		...
		Course course377 = new Course(com326, "Operating Systems", com326, time13, time14, TTH() );
